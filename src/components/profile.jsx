  ...
  return (
    <section className="space-y-6 sm:space-y-7">
      ...
      <div className="flex flex-wrap items-center gap-2 pt-1 sm:gap-3">
              <Button
                variant="outline"
                className="h-8 px-3 text-xs hover:border-clay-400 hover:bg-transparent sm:h-9 sm:px-4 sm:text-sm"
                asChild
              >
                <Link href="/contact">
                  <span className="me-1 size-4 rounded-full bg-gradient-to-br from-clay-300 via-clay-500 to-slate-600 shadow-[0_0_10px_rgba(92,190,255,0.5)] sm:me-1.5 sm:size-5" />
                  Available for work
                </Link>
              </Button>
              <TooltipProvider delayDuration={150}>
                <Tooltip>
                  ...
                  <TooltipContent sideOffset={8}>hi@falakgala.dev</TooltipContent>
                </Tooltip>
              </TooltipProvider>
      </div>
    </section>
