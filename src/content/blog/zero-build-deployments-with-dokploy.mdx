...
![OutCallerAI deployment architecture: GitHub Actions builds images, GHCR stores them, and Dokploy deploys them on a DigitalOcean Droplet](/writing/outcaller-dokploy-architecture.png)
