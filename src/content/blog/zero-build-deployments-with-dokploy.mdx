...
![OutCallerAI deployment architecture: GitHub Actions builds images, GHCR stores them, and Dokploy deploys them on a DigitalOcean Droplet](/blog/outcaller-dokploy-architecture.png)
